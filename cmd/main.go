...
import (
	...
	"bosh-compile/pkg/cmd"
	"bosh-compile/pkg/util"
	"bosh-compile/pkg/version"
...
func init() {
	...
	versionOutput = fmt.Sprintf("bosh-compile version %s\n", RootCmd.Version)
...
var RootCmd = &cobra.Command{
	Use:   "bc",
	Short: "bc compile",
	Long:  `a CLI attempt to compile a BOSH package without a director`,
